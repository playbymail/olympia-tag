...
auto_orc(int who)
{
  ...
  loop_here(where,i) {
	...
	subkind(i) == sub_orc_stronghold_notdone) found = 1;
    if (subkind(i) == sub_orc_stronghold &&
	!building_owner(i)) {
