...
//
//
static void copy_file_slow(FILE *inf, FILE *out)
{
  char buf[1024];
...
times_masthead(void)
{
	...
	/* 	fprintf(fp, "To: togods%d@pbm.com\n\n",game_number); */
	fprintf(fp, "\n   +----------------------------------------------------------------------+\n");
	fprintf(fp, "   | The Gods Speak %53s |\n", date);
	fprintf(fp, "   | %-68s |\n", issue_s);
	fprintf(fp, "   |                                                                      |\n");
	fprintf(fp, "   | %-40s http://www.pbm.com/oly/tag  |\n", turn_s);
	fprintf(fp, "   |                    Send orders to: orders@tag%d.pbm.com               |\n", game_number);
	fprintf(fp, "   +----------------------------------------------------------------------+\n\n");
