...
static int v_generic_harvest(struct command *c, int number, int days, struct harvest *t);
static int d_generic_harvest(struct command *c, struct harvest *t);
static int i_generic_harvest(struct command *c, struct harvest *t);
