...
struct box {
    ...
    effects_list effects;      /* ilist of effects */
...
struct entity_player {
  ...
  const char *email;
  const char *vis_email;		/* address to put in player list */
  const char *password;
...
#if 0
        effects_list effects;        /* ilist of effects on char */
#endif 0
...
#if 0
        effects_list effects;        /* ilist of effects on location */
#endif 0
...
#if 0
        effects_list effects;        /* ilist of effects on sub-location */
#endif 0
