...
int
i_strcmp(const char *s, const char *t)
{
	char a, b;
...
static int
fuzzy_transpose(const char *one, const char *two, int l1, int l2)
{
	int i;
	char buf[LEN];
	char tmp;
...
static int
fuzzy_one_less(const char *one, const char *two, int l1, int l2)
{
	int count = 0;
	int i, j;
...
static int
fuzzy_one_extra(const char *one, const char *two, int l1, int l2)
{
	int count = 0;
	int i, j;
...
static int
fuzzy_one_bad(const char *one, const char *two, int l1, int l2)
{
	int count = 0;
	int i;
...
int
fuzzy_strcmp(const char *one, const char *two)
{
	int l1 = strlen(one);
	int l2 = strlen(two);
