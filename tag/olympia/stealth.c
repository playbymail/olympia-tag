...
static void add_contact(int a, int b);
static void add_fill(int where, ilist *l, int max_depth, int depth);
...
v_petty_thief(struct command *c)
{
	...
	switch (c->use_exp) {
	case exp_novice:        chance = 5; break;
	case exp_journeyman:	chance = 3; break;
	case exp_teacher:	chance = 1; break;
	case exp_master:        chance = 0; break;
	case exp_grand:         chance = 0; break;
	default:                chance = 0;
	}
...
d_petty_thief(struct command *c)
{
	 ...
	 */
	switch (c->use_exp) {
	case exp_novice:          amount = 1; break;
	case exp_journeyman:	  amount = 2; break;
	case exp_teacher:	  amount = 4; break;
	case exp_master:          amount = 7; break;
	case exp_grand:           amount = 10; break;
